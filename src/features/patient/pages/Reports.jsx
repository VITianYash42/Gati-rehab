    ...
    <div className="min-h-screen bg-[#F1F5F9]">
      ...
      <main className="max-w-[1700px] mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-white rounded-[2rem] p-10 shadow-xl border border-slate-50 text-center">
          ...
          <h1 className="text-2xl font-black text-slate-900 mb-2">Reports</h1>
          <p className="text-slate-500 font-bold">View and download your session reports. This feature will be available soon.</p>
        </div>
      </main>
    </div>
  );
